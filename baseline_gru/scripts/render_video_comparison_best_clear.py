...
WINDOW_PRED_PATH = BASELINE_DIR / "results" / "video_project_gru_window_predictions.csv"
MERGED_PRED_PATH = BASELINE_DIR / "results" / "video_project_gru_sequence_prediction.csv"
OUTPUT_PATH = BASELINE_DIR / "results" / "video_project_gru_comparison_clear.mp4"
...
def draw_panel(
    ...
    canvas = draw_text(canvas, "Best GRU Comparison", (video_w + 20, 18), FONT_TITLE, (255, 255, 255))
    ...
    footer1 = "Best numeric GRU model (relative+geometry+velocity)."
    footer2 = "GT stays fixed; prediction timeline grows cumulatively."
...
def main() -> None:
    ...
    cap.release()
    writer.release()
    print(f"Saved best comparison video to: {OUTPUT_PATH}")
